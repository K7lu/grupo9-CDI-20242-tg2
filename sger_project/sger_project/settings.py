"""
Django settings for sger_project project.
...
SECRET_KEY = 'django-insecure-$0j_phdt4h8vun_&j*)pp&nprbj5qcpn!=-j(1pz*3rtl_b2)g'
...
MIDDLEWARE = [
    ...
    'sger_project.middleware.AddUserToContextMiddleware',
    'sger.middleware.LoginRequiredMiddleware',
]

ROOT_URLCONF = 'sger_project.urls'
...
WSGI_APPLICATION = 'sger_project.wsgi.application'
